            ...
            <form id="updatePatient">
                <div class="modal-body">
                    ...
                    <div class="row mb-5 mb-lg-3 mb-md-3 form-appointment">
                        <div class="col-6">
                            <div class="form-floating">
                                <input type="email" class="form-control" name="email" placeholder="Enter you email here:" required="" disabled>
                        ...
                        <div class="col-6">
                            <div class="form-floating">
                                <input type="number_format" class="form-control" name="phone_number" placeholder="Enter you phone number here" required="" disabled>
                    ...
                    <div class="form-floating form-appointment">
                        <input type="date" class="form-control" name="date_of_birth" placeholder="Enter your date of birth" required="" disabled>
                    ...
                    <div class="row mb-5 mb-lg-3 pt-4 mb-md-3 form-appointment">
                        <div class="col-7">
                            <div class="form-floating">
                                <input type="text" class="form-control" name="street" placeholder="Street" required="" disabled>
                                <label for="text">Street</label>
                            </div>
                        </div>
                        <div class="col-5">
                            <div class="form-floating">
                                <input type="text" class="form-control" name="baranggay" placeholder="Baranggay" required="" disabled>
                    ...
                    <div class="row form-appointment">
                        <div class="col-6">
                            <div class="form-floating">
                                <input type="text" class="form-control" name="city" placeholder="City/Municipality" required="" disabled>
                                <label for="text">City/Municipality</label>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-floating">
                                <input type="text" class="form-control" name="province" placeholder="Province" required="" disabled>
